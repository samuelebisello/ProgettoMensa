...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(ImmutableList.of("Authorization", "Cache-Control", "Content-Type", "X-PINGOTHER", "Content-Disposition"));
    ...
    SimpleUrlAuthenticationFailureHandler failureHandler() {
        ...
        failureHandler.setRedirectStrategy((HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, String s) -> {
            httpServletResponse.sendError(400, "non sei autorizzato");
        });
        return failureHandler;
    }

    @Bean
    FilterRegistrationBean disableAutoRegistration(final AuthTokenFilter filter) {
